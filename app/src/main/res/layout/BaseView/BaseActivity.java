...
import com.example.user.glad_passenager.Navigation.ContactActivity;
import com.example.user.glad_passenager.Navigation.PersonalActivity;
import com.example.user.glad_passenager.Navigation.RecordActivity;
...
public class BaseActivity extends AppCompatActivity{
    ...
    public void setContentView(@LayoutRes int layoutResID){
        ...
        MyAdapter adapter = new MyAdapter(com.example.user.glad_passenager.BaseView.BaseActivity.this, navigations);
